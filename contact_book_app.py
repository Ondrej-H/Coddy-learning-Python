...
"""
Now that you've built all the individual functions for the Contact Book,
it's time to put them together to create the full program!
...
Prints 'Invalid choice. Please try again.' if the user enters a choice that is not
one of the valid menu options.
...
This final step combines all the knowledge you've gained into a fully
functioning Contact Book application. Enjoy seeing your hard work come together!
